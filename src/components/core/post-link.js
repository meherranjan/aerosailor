...
const PostLink = ({ edges }) => {
    return edges
        ...
        .map((edge) => {
            ...
            return (
                <div key={edge.node.id} className="featured-posts-list">
                    <div className="post-image">
                        <Img fluid={fm.thumbnail.childImageSharp.fluid} alt={fm.title} />
                    </div>
                    <div className="post-date">{fm.created}</div>
