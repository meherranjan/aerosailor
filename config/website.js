...
module.exports = {
  ...
  title: 'Aerosailor — JS & Everything Else', // Navigation and Site Title
  titleAlt: 'Aerosailor', // Title for JSONLD
  description: 'A blog featuring content on JavaScript, ReactJS, Functional Programming, Elm, Machine Learning, Technology, Web, Scrum, Book Reviews & Lifestyle.',
  ...
  author: 'meherranjan', // Author for schemaORGJSONLD
  themeColor: '#3D63AE',
  backgroundColor: '#FFF',
